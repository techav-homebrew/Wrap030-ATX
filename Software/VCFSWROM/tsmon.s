...
CON_OT2:
        ...
        beq     CON_OT2
CON_OT3:
        move.b  %a1@(comRegMSR),%d1     | read modem status register
        btst    #5,%d1                  | check if terminal is ready (DSR)
        beq     CON_OT1                 | repeat until terminal ready
        move.b  %a1@(comRegLSR),%d1     | read Line Status Register
